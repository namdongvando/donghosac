...
//        return về mảng json
        ...
        foreach ($a as $k => $Menu) {
            ...
            foreach ($body as $k1 => $menuCap2) {
                ...
                if ($sub) {
                    foreach ($sub as $k2 => $menuCap3) {
                        $sub2 = $this->Menu->MenuByGroupThemeParent($this->NameTheme, $menuCap3["Groups"], $menuCap3["IDMenu"], FALSE);
                        $sub[$k2]['submenu'] = $sub2;
                    }
                    $body[$k1]['submenu'] = $sub;
                }
...
//        var_dump($this->TopMainMenu);
    ...
    function head() {
        ...
        <link href="/public/home/assets/css/option5daotao.css" rel="stylesheet" type="text/css"/>
        <link href="/public/home/css/style.css" rel="stylesheet" type="text/css"/>
        <link href="/public/home/assets/css/MauTemplate.css" rel="stylesheet" type="text/css"/>
        <link href="/public/home/daotao/style.css" rel="stylesheet" type="text/css"/>
...
//                                                            Cấp 2
    ...
    function product($produc) {
        $produc = (is_object($produc)) ? $produc : new \Model\Products($produc);
        ...
        <div class="product-container">
            ...
            <div class="right-block">
                ...
                <div class="content_price">
                    <span class="price product-price">{{<?php echo $produc->Price ?>|number:0}}</span><sub>đ</sub>
                </div>
                                    ...
                                    <div class="post" >
                                        ...
                                        <div class="post-desc">
                                            <h3 class="post-title text-center">
                                                <a href="<?php echo $news->linkNewsCurent(); ?>"><?php echo $_news["Name"] ?></a>
                                            </h3>
                                        </div>
                                    </div>
                                </div>
    ...
    function mau3($Pages) {
        ...
        ?> 
        <div class="Mau3">
            <h2 class="text-center Mau3-title">
                <span><?php echo $MPages->Name ?></span>
            </h2>
            <div class="container">
                <div >
            ...
            <div class="container"  >
                ...
                <div class="blog-list">
                    <h2 class="page-heading">
                        <span class="page-heading-title"><?php echo $Pages["Name"] ?></span>
                    </h2>
