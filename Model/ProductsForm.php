...
use PFBC\FormRender as PFBCFormRender;
...
class ProductsForm implements ProductsIForm
{
    ...
    public static function ID($val = null)
    {
        $properties = self::$FormClass;
        $properties["value"] = $val;
        $properties[PFBCFormRender::Required] = '';
        $name = self::FormName . "[" . __FUNCTION__ . "]";
    ...
    public static function Title($val = null)
    {
        ...
        $properties["id"] = __FUNCTION__;
        $name = self::FormName . "[" . __FUNCTION__ . "]";
        return new FormRender(new Element\Textarea("SEO title", $name, $properties));
    }
    ...
    public static function catIDSeach($val, $name)
    {
        $properties = self::$FormClass;
        $properties["value"] = $val;
        $properties["Id"] = __FUNCTION__;
    ...
    public static function seachName($val, $name)
    {
        $properties = self::$FormClass;
        $properties["value"] = $val;
        $properties["Id"] = __FUNCTION__;
