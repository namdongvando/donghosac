...
-- Généré le: Mar 16 Janvier 2018 à 08:05
...
--
-- Base de données: `oetkpjhosting_matongcoba`
--
...
CREATE TABLE IF NOT EXISTS `bluearc_danhmuc` (
...
CREATE TABLE IF NOT EXISTS `bluearc_hotro` (
...
CREATE TABLE IF NOT EXISTS `bluearc_khachang` (
  `email` varchar(200) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bluearc_lichsu` (
...
CREATE TABLE IF NOT EXISTS `bluearc_menu` (
  `id` int(11) NOT NULL DEFAULT '0',
...
(9, 'Trang chủ', '/', 0, 'M1', 0),
(10, 'Dịch Vụ', '/about/', 0, 'M1', 0),
(11, 'Thông Tin', '/news/', 0, 'M1', 0),
(12, 'Biểu Phí', '/dang-muc/', 0, 'M1', 0),
(13, 'Hợp Tác', '#', 0, 'M3', 0),
...
CREATE TABLE IF NOT EXISTS `bluearc_option` (
...
('Lang_BgColor', 2, '#fff', '', '{"type":"2","title":"bgcolor"}'),
('Lang_DanhMuc', 2, 'Danh Mục Bài Viết', '', '{"type":"2","title":"Danh Mục Bài Viết"}'),
('Lang_Facebook', 2, '<div class="fb-page" data-href="https://www.facebook.com/nguyenvando.net/" data-tabs="messages ,events" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="false"><blockquote cite="https://www.facebook.com/nguyenvando.net/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/nguyenvando.net/">Nguyenvando.net</a></blockquote></div>', '', '{"type":"2","title":"Facebook"}'),
('Lang_GioiThieuChung', 2, 'Giới Tihu65 CHung', '', '{"type":"2","title":"Giới Thiệu Chung"}'),
('Lang_Slogan', 2, 'Chia sẻ kiem', '', '{"type":"2","title":"Slogan"}'),
('Lang_TrangXaHoi', 2, 'Trang Xã Hội', '', '{"type":"2","title":"Trang Xã Hội"}'),
('Lang_Webname', 2, 'Mật ong cô ba', '', '{"type":"2","title":"Matongcoba"}'),
('Option_Banner', 1, 'tooplate_image_08.jpg', '', '{"type":"1","title":"Banner"}'),
('Option_BGBody', 1, 'background_banner_2_.jpg', '', '{"type":"1","title":"BgBody"}'),
('Option_BgMenu', 1, 'tooplate_menu.png', '', '{"type":"1","title":"BgMenu"}'),
('Option_Logo', 1, 'logo-vksos.png', '', '{"type":"1","title":"Logo Web"}'),
('SEO_Des', 0, 'description', 'description', ''),
('SEO_Google', 0, '<meta name="google-site-verification" content="lcyB2yHJ9EB7eZq4UVbb_qsowgfWYBg-eWQcC-vyCO4" />\r\n<div id="fb-root"></div>\r\n<script>(function(d, s, id) {\r\n  var js, fjs = d.getElementsByTagName(s)[0];\r\n  if (d.getElementById(id)) return;\r\n  js = d.createElement(s); js.id = id;\r\n  js.src = ''https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v2.11'';\r\n  fjs.parentNode.insertBefore(js, fjs);\r\n}(document, ''script'', ''facebook-jssdk''));</script>', '<meta name="google-site-verification" content="lcyB2yHJ9EB7eZq4UVbb_qsowgfWYBg-eWQcC-vyCO4" />\r\n<div id="fb-root"></div>\r\n<script>(function(d, s, id) {\r\n  var js, fjs = d.getElementsByTagName(s)[0];\r\n  if (d.getElementById(id)) return;\r\n  js = d.createElement(s); js.id = id;\r\n  js.src = ''https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v2.11'';\r\n  fjs.parentNode.insertBefore(js, fjs);\r\n}(document, ''script'', ''facebook-jssdk''));</script>', ''),
('SEO_Keyword', 0, 'keyword', 'keyword', ''),
('SEO_Title', 0, 'Mât ong co ba', 'Mât ong co ba', ''),
('Social_Facebook', 0, '', '', ''),
('Social_Google', 0, '', '', ''),
('Social_Twitter', 0, '', '', '');
...
CREATE TABLE IF NOT EXISTS `bluearc_pages` (
...
CREATE TABLE IF NOT EXISTS `bluearc_quantri` (
...
CREATE TABLE IF NOT EXISTS `bluearc_sanpham` (
...
CREATE TABLE IF NOT EXISTS `bluearc_tin` (
  `IdTin` varchar(20) CHARACTER SET utf8 NOT NULL DEFAULT '0',
  `title` varchar(250) CHARACTER SET utf8 NOT NULL,
  `keyword` varchar(250) CHARACTER SET utf8 NOT NULL,
  `description` text CHARACTER SET utf8 NOT NULL,
...
('201712181513604890', '', '', '', 78, 'sdfsd', 'sdfsd201712181513604890', '<p>fsdfsd</p>\r\n', '<p>sdfsd</p>\r\n', 1, '2017-12-18 08:48:10', 'tooplate_image_08.jpg', 1, 0, 1);
...
CREATE TABLE IF NOT EXISTS `vksos_danhmuc` (
...
CREATE TABLE IF NOT EXISTS `vksos_hotro` (
...
CREATE TABLE IF NOT EXISTS `vksos_khachang` (
  `email` varchar(200) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `vksos_lichsu` (
...
CREATE TABLE IF NOT EXISTS `vksos_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
  `link` text COLLATE utf8_unicode_ci NOT NULL,
  `parent` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `vksos_option` (
...
CREATE TABLE IF NOT EXISTS `vksos_pages` (
  `idPa` int(11) NOT NULL AUTO_INCREMENT,
  `idGroup` tinyint(4) NOT NULL,
  `TieuDe` varchar(500) COLLATE utf8_unicode_ci NOT NULL,
  `TieuDeKD` varchar(500) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `vksos_quantri` (
...
CREATE TABLE IF NOT EXISTS `vksos_sanpham` (
...
CREATE TABLE IF NOT EXISTS `vksos_tin` (
  `IdTin` varchar(20) NOT NULL DEFAULT '0',
  `title` varchar(250) NOT NULL,
  `keyword` varchar(250) NOT NULL,
  `description` text NOT NULL,
